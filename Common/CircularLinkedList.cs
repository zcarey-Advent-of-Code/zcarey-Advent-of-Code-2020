...
namespace Common {
	...
	//Copy pasta from C# LinkedList and adapted to work circularly
	public class CircularLinkedList<T> : ICollection<T>, System.Collections.ICollection, IReadOnlyCollection<T> {
		internal CircularLinkedListNode<T> head;
		internal int count;
	...
	public sealed class CircularLinkedListNode<T> {
		...
		internal CircularLinkedListNode<T> prev;
		internal T item;
